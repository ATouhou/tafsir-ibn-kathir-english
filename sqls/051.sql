...
<span class="taf-ref-3 taf-tr taf-tr-qur">And the distributors of command</span>?" and Ali said, it refers to "The angels."<span class="taf-foot"><span class="n">1</span><span class="t">At-Tabari 22:389-392 and `Abdur-Razzaq 3:41</span></span>
...
<span class="taf-ref-3 taf-tr taf-tr-qur">By the heaven full of Hubuk</span> Ibn \`Abbas said; "Full of beauty, grace, magnificence and perfection."<span class="taf-foot"><span class="n">2</span><span class="t">At-Tabari 22:395-396</span></span> Mujahid, \`Ikrimah, Sa\'d bin Jubayr, Abu Malik, Abu Salih, As Suddi, Qatadah, \`Atiyah Al-\`Awfi, Ar-Rabi\` bin Anas and other said similarly.<span class="taf-foot"><span class="n">3</span><span class="t">At-Tabari 22:396-397</span></span> Ad-Dahhak, Al-Minhal bin \`Amr and others said, "The meandering of the water, sand and plants when the wind passes over them; carving paths out of them, that is the Hubuk."
<br/>
...
<br/>
Al-Kharrasun are those who claim that they will never be brought back to life, doubting the coming of Resurrection."<span class="taf-foot"><span class="n">5</span><span class="t">At-Tabari 22:400</span></span>
<br/>
